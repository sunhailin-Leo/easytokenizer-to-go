...
class Tokenizer : public BasicTokenizer
{
  public:
    ...
    void wordpiece_tokenize_with_offsets(const std::string& text,
    ...
    // encode single sentence with ids
    void encodeWithIds(const std::string& text,
        std::vector<SizeT>& input_ids,
    ...
    void encodeMultiThread(const std::vector<std::string>& texts,
